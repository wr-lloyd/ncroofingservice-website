...
export const metadata: Metadata = {
  ...
  description: 'Contact NC Roofing Service for free roof inspections in North Carolina. Call (336) ROOFING or request a callback. Serving Durham, Raleigh, Chapel Hill, Cary & surrounding areas.',
