...
export const metadata: Metadata = {
  ...
  description: 'Contact NC Roofing Service for free roof inspections in the NC Triangle. Call (336) ROOFING or request a callback. Serving Durham, Raleigh, Chapel Hill, Cary & surrounding areas.',
