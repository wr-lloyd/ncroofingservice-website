...
export const metadata: Metadata = {
  ...
  description:
    'NC Roofing Service serves the entire NC Triangle including Durham, Raleigh, Cary, Chapel Hill, Apex, Wake Forest, and 30+ cities. Find roofing services near you.',
  keywords:
    'NC Triangle roofing, roofing service areas, Durham roofer, Raleigh roofing, Chapel Hill roof repair, Wake County roofing',
  openGraph: {
...
// Cities that have a dedicated /locations/{slug}-nc page. Keep this in sync
// with the keys in app/(site)/locations/[city]/page.tsx cityData.
const PUBLISHED_CITY_SLUGS = new Set<string>([
  'durham-nc',
  'roxboro-nc',
  'oxford-nc',
  'creedmoor-nc',
...
// Cities promoted with a colored card. These match the {city}-nc slugs above.
...
function regionCounties(r: Region): string[] {
  return r.counties.map((c) => `${c} County`)
}
    ...
    <main className="pt-20">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mt-2 mb-6">Areas We Serve</h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-16">
            {regions.map((region) => (
              <div key={region.id} className="border-b border-slate-200 pb-16 last:border-0 last:pb-0">
                <div className="flex flex-col lg:flex-row lg:items-start gap-8">
                  ...
                  <div className="lg:w-1/3">
                    ...
                    <h2 className="text-2xl font-bold text-slate-900 mb-4">{regionCounties(region).join(', ')}</h2>
                    <div className="bg-slate-50 rounded-xl p-4 mb-4">
                      <p className="text-slate-600 text-sm mb-2">Your Local Expert:</p>
                      <Link
                        href={`/team/${region.lead.slug}`}
                  ...
                  <div className="lg:w-2/3">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      {region.displayCities.map((cityName) => {
                        const slug = citySlug(cityName)
                        const hasPage = PUBLISHED_CITY_SLUGS.has(slug)
      ...
      <section className="py-20 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Don&apos;t See Your City?</h2>
