...
const projects = [
  {
    ...
    beforeImage: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?w=800&q=80&auto=format&fit=crop',
    afterImage: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80&auto=format&fit=crop',
  },
  {
    ...
    beforeImage: 'https://images.unsplash.com/photo-1527482797697-8795b05a13fe?w=800&q=80&auto=format&fit=crop',
    afterImage: 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=800&q=80&auto=format&fit=crop',
  },
  {
    ...
    beforeImage: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&q=80&auto=format&fit=crop',
    afterImage: 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=800&q=80&auto=format&fit=crop',
  },
  {
    ...
    beforeImage: 'https://images.unsplash.com/photo-1502005229762-cf1b2da7c5d6?w=800&q=80&auto=format&fit=crop',
    afterImage: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=800&q=80&auto=format&fit=crop',
  },
  {
    ...
    beforeImage: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800&q=80&auto=format&fit=crop',
  ...
  },
  {
    ...
    beforeImage: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=800&q=80&auto=format&fit=crop',
    afterImage: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&q=80&auto=format&fit=crop',
  },
]
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <span className="text-[#C8102E] font-semibold text-sm uppercase tracking-wider">Our Work</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, idx) => (
              <div 
                key={idx}
                className="bg-white rounded-2xl overflow-hidden border border-slate-200 hover:border-[#C8102E]/30 hover:shadow-lg transition-all group"
              >
                {/* Before/After Slider */}
                ...
                <div className="p-6">
                  ...
                  <p className="text-[#C8102E] text-sm mb-3">{project.location}</p>
          ...
          <div className="mt-12 bg-white rounded-2xl p-8 border border-slate-200 text-center shadow-sm">
            <svg className="w-12 h-12 text-[#C8102E] mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 text-[#C8102E] font-medium hover:text-[#a50d25] transition-colors"
            >
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#C8102E] font-semibold text-sm uppercase tracking-wider">Our Process</span>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-[#C8102E] rounded-[2px] flex items-center justify-center mx-auto mb-6 text-white font-bold text-2xl shadow-md">1</div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-[#C8102E] rounded-[2px] flex items-center justify-center mx-auto mb-6 text-white font-bold text-2xl shadow-md">2</div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-[#C8102E] rounded-[2px] flex items-center justify-center mx-auto mb-6 text-white font-bold text-2xl shadow-md">3</div>
