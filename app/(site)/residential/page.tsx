          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-slate-600 text-lg mb-8">
                ...
                and operated in Rougemont, NC. Owner <Link href="/team/randy-butler" className="font-semibold text-slate-900 underline decoration-brand-red/40 underline-offset-4 hover:decoration-brand-red transition-colors">Randy Butler</Link> lives and works in this community — 
