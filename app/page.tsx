      ...
      <section className="py-12 bg-gradient-to-r from-green-600 to-green-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <Link
              href="/start"
              className="inline-flex items-center gap-2 bg-white hover:bg-green-50 text-green-700 px-8 py-4 rounded-xl font-semibold transition-colors"
            >
      ...
      <section className="py-24 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-blue-500 font-semibold text-sm uppercase tracking-wider">What We Do</span>
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">Roofing Services</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link href="/services/fortified-roofing" className="group md:col-span-2 lg:col-span-1">
              <div className="bg-gradient-to-br from-green-900/30 to-slate-800 rounded-2xl p-8 border border-green-500/30 hover:border-green-500/50 transition-all h-full relative overflow-hidden">
                ...
                <div className="w-16 h-16 bg-green-600/20 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <svg className="w-8 h-8 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold text-white mb-3">FORTIFIED Roofing</h3>
                <p className="text-slate-400 mb-4">Storm-resistant roofing that may qualify for insurance discounts. Superior protection for NC weather.</p>
                <span className="text-green-400 font-medium group-hover:text-green-300 transition-colors inline-flex items-center gap-2">
                  Learn More
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="/services/storm-damage-insurance" className="group">
              <div className="bg-slate-800/50 rounded-2xl p-8 border border-white/5 hover:border-blue-500/50 transition-all h-full">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Insurance Claims</h3>
                <p className="text-slate-400 mb-4">We help document damage, meet with adjusters, and advocate for fair compensation on your claim.</p>
                <span className="text-blue-500 font-medium group-hover:text-blue-400 transition-colors inline-flex items-center gap-2">
                  Get Help
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
            ...
            <Link href="/services/roof-replacement" className="group">
              <div className="bg-slate-800/50 rounded-2xl p-8 border border-white/5 hover:border-blue-500/50 transition-all h-full">
                ...
                <p className="text-slate-400 mb-4">Complete roof replacement with premium materials. Extended warranties from GAF, Owens Corning & more.</p>
                <span className="text-blue-500 font-medium group-hover:text-blue-400 transition-colors inline-flex items-center gap-2">
                  Learn More
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            ...
            <Link href="/services/roof-repair" className="group">
              <div className="bg-slate-800/50 rounded-2xl p-8 border border-white/5 hover:border-blue-500/50 transition-all h-full">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Roof Repair</h3>
                <p className="text-slate-400 mb-4">Leak repairs, shingle replacement, flashing fixes. We address the source of the problem, not just the symptoms.</p>
                <span className="text-blue-500 font-medium group-hover:text-blue-400 transition-colors inline-flex items-center gap-2">
                  Learn More
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            ...
            {/* Emergency Services */}
            <Link href="/services/roof-repair" className="group">
              <div className="bg-slate-800/50 rounded-2xl p-8 border border-red-500/30 hover:border-red-500/50 transition-all h-full relative overflow-hidden">
                <div className="absolute top-4 right-4">
                ...
                <p className="text-slate-400 mb-4">Storm damage? Active leak? Call or text anytime. We respond quickly to protect your property.</p>
                <span className="text-red-400 font-medium group-hover:text-red-300 transition-colors inline-flex items-center gap-2">
                  Get Help Now
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
            ...
            <Link href="/contact" className="group">
              <div className="bg-slate-800/50 rounded-2xl p-8 border border-white/5 hover:border-blue-500/50 transition-all h-full">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Free Inspections</h3>
                <p className="text-slate-400 mb-4">Not sure what you need? Start with a free inspection. Honest assessment, no pressure, no obligation.</p>
                <span className="text-blue-500 font-medium group-hover:text-blue-400 transition-colors inline-flex items-center gap-2">
                  Schedule Now
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          ...
          <div className="text-center mt-12">
            <Link
              href="/services"
              className="inline-flex items-center gap-2 border border-white/20 hover:bg-white/10 text-white px-8 py-3 rounded-lg font-semibold transition-colors"
            >
              View All Services
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold text-lg mb-1">Triple Certified</h3>
                    <p className="text-slate-400">GAF, Owens Corning, and CertainTeed certified — access to premium warranties most contractors can&apos;t offer.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold text-lg mb-1">FORTIFIED by IBHS</h3>
                    <p className="text-slate-400">We install storm-resistant roofing systems that may qualify for insurance discounts.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold text-lg mb-1">Honest, Transparent Pricing</h3>
                    <p className="text-slate-400">We explain every line item. No hidden fees, no surprises, no pressure sales tactics.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold text-lg mb-1">Truly Local</h3>
                    <p className="text-slate-400">Based in Rougemont since 2018. We&apos;re your neighbors — our community matters to us.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-blue-600/20 to-blue-600/5 rounded-2xl p-8 text-center border border-blue-500/20">
                <div className="text-5xl font-bold text-white mb-2">7+</div>
                <div className="text-slate-400">Years in Business</div>
              </div>
              <div className="bg-gradient-to-br from-green-600/20 to-green-600/5 rounded-2xl p-8 text-center border border-green-500/20">
                <div className="text-5xl font-bold text-white mb-2">A+</div>
                <div className="text-slate-400">BBB Rating</div>
              </div>
              <div className="bg-gradient-to-br from-amber-600/20 to-amber-600/5 rounded-2xl p-8 text-center border border-amber-500/20">
                <div className="text-5xl font-bold text-white mb-2">3</div>
                <div className="text-slate-400">Certifications</div>
              </div>
              <div className="bg-gradient-to-br from-purple-600/20 to-purple-600/5 rounded-2xl p-8 text-center border border-purple-500/20">
      ...
      <section className="py-24 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">Serving the NC Triangle</h2>
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {['Rougemont', 'Durham', 'Raleigh', 'Chapel Hill', 'Cary', 'Hillsborough', 'Wake Forest', 'Apex', 'Butner', 'Creedmoor', 'Oxford', 'Mebane'].map((city) => (
              <Link 
                key={city}
                href="/locations"
                className="bg-slate-800/50 hover:bg-slate-800 border border-white/5 hover:border-blue-500/30 rounded-xl p-4 text-center transition-all group"
              >
                <span className="text-white font-medium group-hover:text-blue-400 transition-colors">{city}</span>
                <span className="text-slate-500 text-sm block">NC</span>
              </Link>
            ))}
          </div>
