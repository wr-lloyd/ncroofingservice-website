  ...
  return (
    <main className="pt-20">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-slate-400 text-lg">
                <p>
                  B&C Roofing and Repair, LLC was founded in 2018 by <strong className="text-white">Randall Butler</strong>, 
            ...
            <div className="bg-slate-900/50 rounded-2xl p-8 border border-white/5">
              <div className="text-center mb-8">
                ...
                <h3 className="text-white font-bold text-2xl">Randall Butler</h3>
                <p className="text-blue-500">Owner & Founder</p>
              </div>
      ...
      <section className="py-24 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">Your Local Roofing Experts</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Randy Butler */}
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-white/5 text-center">
              ...
              <h3 className="text-white font-bold text-xl mb-1">Randy Butler</h3>
              <p className="text-green-400 text-sm font-medium mb-2">Owner & Greater Durham</p>
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {['Durham', 'Rougemont', 'Butner', 'Creedmoor'].map((city) => (
                  <span key={city} className="px-2 py-1 bg-slate-700 text-slate-400 text-xs rounded-full">{city}</span>
                ))}
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-white/5 text-center">
              ...
              <h3 className="text-white font-bold text-xl mb-1">Mike Villarroel</h3>
              <p className="text-blue-400 text-sm font-medium mb-2">Greater Raleigh</p>
              <p className="text-slate-400 text-sm mb-4">
            ...
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-white/5 text-center">
              ...
              <h3 className="text-white font-bold text-xl mb-1">Preston Mayo</h3>
              <p className="text-purple-400 text-sm font-medium mb-2">Greater Chapel Hill</p>
              <p className="text-slate-400 text-sm mb-4">
      ...
      <section className="py-24 bg-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-blue-500 font-semibold text-sm uppercase tracking-wider">Our Journey</span>
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-2">Building Trust Since 2018</h2>
          </div>
          
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-blue-600/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <span className="text-blue-500 font-bold text-2xl">2018</span>
              </div>
              <h3 className="text-white font-bold text-lg mb-2">Company Founded</h3>
              <p className="text-slate-400 text-sm">Randall Butler launches B&C Roofing in Rougemont, NC</p>
            </div>
            
            <div className="text-center">
              <div className="w-20 h-20 bg-blue-600/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <span className="text-blue-500 font-bold text-2xl">2020</span>
              </div>
              <h3 className="text-white font-bold text-lg mb-2">Certifications Earned</h3>
              <p className="text-slate-400 text-sm">GAF, Owens Corning, and CertainTeed certified</p>
            </div>
            
            <div className="text-center">
              <div className="w-20 h-20 bg-blue-600/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <span className="text-blue-500 font-bold text-2xl">2023</span>
              </div>
              <h3 className="text-white font-bold text-lg mb-2">BBB Accredited</h3>
              <p className="text-slate-400 text-sm">Earned BBB A+ accreditation in May 2023</p>
            </div>
            
            <div className="text-center">
              <div className="w-20 h-20 bg-green-600/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <span className="text-green-500 font-bold text-2xl">Now</span>
              </div>
              <h3 className="text-white font-bold text-lg mb-2">Serving the Triangle</h3>
              <p className="text-slate-400 text-sm">Protecting homes across Durham, Raleigh, and beyond</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-blue-500 font-semibold text-sm uppercase tracking-wider">Our Technology</span>
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">Modern Tools, Better Results</h2>
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-900/50 rounded-2xl p-8 border border-white/5 text-center">
              ...
              <h3 className="text-white font-bold text-xl mb-3">EagleView Imaging</h3>
              <p className="text-slate-400">Satellite and aerial imaging for precise roof measurements and accurate estimates.</p>
            </div>
            ...
            <div className="bg-slate-900/50 rounded-2xl p-8 border border-white/5 text-center">
              ...
              <h3 className="text-white font-bold text-xl mb-3">PLRB Weather Mapping</h3>
              <p className="text-slate-400">Advanced weather data to document storm damage for insurance claims.</p>
            </div>
            
            <div className="bg-slate-900/50 rounded-2xl p-8 border border-white/5 text-center">
              <div className="w-16 h-16 bg-amber-600/20 rounded-xl flex items-center justify-center mx-auto mb-6">
                <svg className="w-8 h-8 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <h3 className="text-white font-bold text-xl mb-3">Digital Thermal Testing</h3>
              <p className="text-slate-400">Infrared technology to detect hidden moisture and air leaks in your roof.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-blue-500 font-semibold text-sm uppercase tracking-wider">Hiring a Roofer</span>
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">What to Expect from a Professional Roofer</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-slate-900/50 rounded-2xl p-8 border border-white/5">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl font-bold text-white">Proper Insurance</h3>
              </div>
              ...
              <div className="space-y-4 mb-6">
                <h4 className="text-white font-semibold">What to look for:</h4>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="text-slate-300"><strong className="text-white">General Liability:</strong> At least $1 million, preferably $2 million</span>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="text-slate-300"><strong className="text-white">Workers&apos; Compensation:</strong> Must cover the entire crew</span>
              ...
              <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-green-400 font-semibold">B&C Roofing Provides:</span>
                </div>
            ...
            <div className="bg-slate-900/50 rounded-2xl p-8 border border-white/5">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl font-bold text-white">Manufacturer Certification</h3>
              </div>
              
              <p className="text-slate-400 mb-6">
                Certification from shingle manufacturers isn&apos;t just a badge — it <strong className="text-white">directly determines 
                what warranty you can receive</strong>. Different certification levels unlock different warranty options.
              </p>

              <div className="space-y-4 mb-6">
                <h4 className="text-white font-semibold">Certification Levels (Example: GAF):</h4>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="text-slate-300"><strong className="text-white">Certified Contractor:</strong> Basic level</span>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="text-slate-300"><strong className="text-white">Master Elite:</strong> Top 2% of contractors</span>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="text-slate-300"><strong className="text-white">CertainTeed SELECT:</strong> Elite certification</span>
          ...
          {/* Warning Box */}
          <div className="mt-12 bg-red-500/10 border border-red-500/20 rounded-2xl p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-xl font-bold text-white mb-2">Watch Out for &quot;Storm Chasers&quot;</h4>
                <p className="text-slate-400">
                  ...
                  <strong className="text-white"> Always verify insurance and certifications before signing anything.</strong>
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-2 mb-4">What We Stand For</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-slate-400">Highest level of service and quality workmanship on every project.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-white font-bold text-xl mb-3">Honesty</h3>
              <p className="text-slate-400">Transparent pricing and honest recommendations — always.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-400">We live here too. Your community is our community.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-white font-bold text-xl mb-3">Satisfaction</h3>
              <p className="text-slate-400">Your complete satisfaction is our ultimate goal.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-4">Follow Our Work</h2>
