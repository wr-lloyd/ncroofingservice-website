    ...
    <main className="pt-20">
      ...
      <section className="py-16 bg-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white text-center mb-12">Why Replace with B&C</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-900/50 rounded-2xl p-8 border border-white/5 text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Premium Warranties</h3>
              <p className="text-slate-400">Our certifications unlock manufacturer warranties up to 50 years — including workmanship coverage.</p>
            </div>
            <div className="bg-slate-900/50 rounded-2xl p-8 border border-white/5 text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Complete Transparency</h3>
              <p className="text-slate-400">Detailed quotes with every line item explained. No hidden fees, no surprises, no high-pressure tactics.</p>
            </div>
            <div className="bg-slate-900/50 rounded-2xl p-8 border border-white/5 text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Clean, Fast Work</h3>
              <p className="text-slate-400">Most roofs done in 1-3 days. We protect your property, clean up daily, and do a final walk-through together.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <span className="text-blue-500 font-semibold text-sm uppercase tracking-wider">Our Philosophy</span>
            <h2 className="text-3xl md:text-4xl font-bold text-white mt-2 mb-4">
              More Than Just Shingles
            </h2>
            <p className="text-slate-400 text-lg max-w-3xl mx-auto">
              At B&C, we believe in the <span className="text-white font-semibold">complete roofing system</span> approach. 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {/* 1. Roof Deck */}
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-white/5 hover:border-blue-500/30 transition-colors group">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-slate-700 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-blue-600/20 transition-colors">
                  <span className="text-blue-400 font-bold text-lg">1</span>
                </div>
                <div>
                  <h3 className="text-white font-bold text-lg mb-1">Roof Deck</h3>
                  <p className="text-slate-400 text-sm">The structural base (plywood or OSB) that everything attaches to. Must be solid, dry, and properly fastened.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-white/5 hover:border-blue-500/30 transition-colors group">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg mb-1">Drip Edge</h3>
                  <p className="text-slate-400 text-sm">Metal flashing along eaves and rakes to direct water away from the deck and fascia, preventing rot.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-white/5 hover:border-blue-500/30 transition-colors group">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg mb-1">Ice & Water Shield</h3>
                  <p className="text-slate-400 text-sm">Self-adhering waterproof membrane in valleys, eaves, and penetrations to prevent leaks from ice dams and wind-driven rain.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-white/5 hover:border-blue-500/30 transition-colors group">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg mb-1">Underlayment</h3>
                  <p className="text-slate-400 text-sm">A protective layer over the entire deck (synthetic or felt) providing secondary water resistance beneath the shingles.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-white/5 hover:border-blue-500/30 transition-colors group">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg mb-1">Flashing</h3>
                  <p className="text-slate-400 text-sm">Custom-installed metal at penetrations and transitions (chimneys, walls, skylights, valleys) to keep water out.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-white/5 hover:border-blue-500/30 transition-colors group">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-slate-700 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-blue-600/20 transition-colors">
                  <span className="text-blue-400 font-bold text-lg">6</span>
                </div>
                <div>
                  <h3 className="text-white font-bold text-lg mb-1">Starter Strip</h3>
                  <p className="text-slate-400 text-sm">The first row at eaves and rakes that seals the roof edge and helps shingles resist wind uplift.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-white/5 hover:border-blue-500/30 transition-colors group">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg mb-1">Shingles</h3>
                  <p className="text-slate-400 text-sm">The primary weather-shedding layer and most visible component — what most people think of as &quot;the roof.&quot;</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-white/5 hover:border-blue-500/30 transition-colors group">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg mb-1">Ventilation</h3>
                  <p className="text-slate-400 text-sm">Balanced airflow (soffit + ridge vents) to regulate attic temperature, prevent moisture, and extend roof life.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-white/5 hover:border-blue-500/30 transition-colors group">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-slate-700 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-blue-600/20 transition-colors">
                  <span className="text-blue-400 font-bold text-lg">9</span>
                </div>
                <div>
                  <h3 className="text-white font-bold text-lg mb-1">Ridge Cap</h3>
                  <p className="text-slate-400 text-sm">Specialized shingles at the roof peak to protect the ridge and allow proper exhaust ventilation.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-900/50 to-blue-800/30 rounded-2xl p-8 border border-blue-500/20">
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div>
                ...
                <p className="text-slate-300 text-lg mb-4">
                  Most roof failures don&apos;t happen because of bad shingles — they happen because one of these system components was <span className="text-white font-semibold">skipped, rushed, or installed incorrectly</span>.
                </p>
      ...
      <section className="py-16 bg-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white text-center mb-4">Premium Materials</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={brand.name} className="bg-slate-800/50 rounded-2xl p-8 border border-white/5">
                <div className={`w-16 h-16 bg-gradient-to-br ${brand.color} rounded-xl flex items-center justify-center mb-4`}>
                ...
                <p className="text-slate-400">{brand.desc}</p>
              </div>
            ))}
          </div>
        </div>
