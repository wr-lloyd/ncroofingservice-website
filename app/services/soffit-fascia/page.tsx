      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-[#C8102E] font-semibold text-sm uppercase tracking-wider">Critical for Roof Health</span>
            ...
            <div className="bg-gradient-to-br from-amber-50 to-slate-100 rounded-3xl p-8">
              ...
              <div className="relative bg-white rounded-2xl p-6 shadow-inner mb-6">
                <div className="text-center">
                  ...
                  {/* Soffit */}
                  <div className="mt-4">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#C8102E]/10 text-[#C8102E] rounded-full text-sm font-medium">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
