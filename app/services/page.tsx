      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <span className="text-brand-red font-semibold text-sm uppercase tracking-wider">Roofing & Exterior Systems</span>
            <h1 className="text-4xl md:text-6xl font-bold text-white mt-2 mb-6">
              Residential and{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-red to-brand-red-dark">Commercial Services</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <p className="text-white font-medium">Questions about your project?</p>
            </div>
            <Link
              href="/contact"
              ...
              >
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-slate-900 mb-2 group-hover:text-brand-red transition-colors">
                      {service.title}
                    </h2>
                    ...
                    <span className="inline-flex items-center gap-2 text-brand-red font-medium group-hover:text-[#a50d25] transition-colors">
                      Learn More
            ...
            <Link href="/services/pergolas" className="group relative h-80 rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-brand-red font-semibold group-hover:text-[#a50d25] inline-flex items-center gap-1 transition-colors">
                    Learn More
                    <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                    </svg>
