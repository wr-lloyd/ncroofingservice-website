...
const commercialServices = [
  {
    ...
    features: ['TPO single-ply membrane', 'EPDM rubber roofing', 'Modified bitumen systems'],
  },
  {
    title: 'Metal Roofing',
  ...
  },
  {
    ...
    features: ['Bi-annual inspections', 'Preventive repairs', 'Detailed documentation'],
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {commercialServices.map((service) => (
              <div
                key={service.title}
                className="bg-slate-50 rounded-2xl p-8 border border-slate-200 hover:border-brand-red/30 hover:shadow-lg transition-all"
              >
