        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-slate-400 mb-4 text-sm">
              Certified, licensed and insured. Local roofing professionals you can trust. Serving the Triangle area since 2018.
            </p>
            <p className="text-slate-500 text-xs italic mb-4">&quot;A roof is only as good as the roofer.&quot;</p>
            <SocialLinks size="sm" />
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/start" className="text-slate-400 hover:text-white transition-colors text-sm">Start Here</Link></li>
