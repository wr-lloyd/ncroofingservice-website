  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-white/95 backdrop-blur-lg border-t border-slate-200 p-3 safe-area-pb shadow-lg">
      <div className="flex gap-3">
        ...
        <a
          href="/contact"
          className="flex-1 flex items-center justify-center gap-2 bg-[#111111] hover:bg-[#333333] text-white py-3 rounded-[2px] font-semibold transition-colors shadow-md"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
